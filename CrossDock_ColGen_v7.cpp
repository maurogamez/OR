...
/* ------------------------------- END: HEURISTIC TO GENERATE COLUMNS ------------------------------- */
   ...
   */
	  ...
	  cplex_sub_x.exportModel("xSubP.lp");
	  cplex_sub_y.exportModel("ySubP.lp");
	  while (RC_FLAG)
	  {
		  RC_FLAG = 0;
